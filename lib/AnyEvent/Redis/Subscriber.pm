package AnyEvent::Redis::Subscriber;
...
AnyEvent::Redis::Subscriber is an event-driven (asynchronous) subscriber for
the Redis publish/subscribe system.  

The main idea is that other clients (such as AnyEvent::Redis) publish messages
...
Redis PublishSubscribe L<http://code.google.com/p/redis/wiki/PublishSubscribe>
